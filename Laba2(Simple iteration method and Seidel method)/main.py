...
# A = np.array([
#     [1.43, 0.21, -0.03, 0.12, -0.13],
#     [-0.03, -1.23, -0.09, 0.17, 0.12],
#     [0.12, -0.03, -1.23, 0.11, -0.03],
#     [0.17, 0.12, -0.03, -1.23, 0.11],
#     [0.11, 0.67, 0.12, -0.03, -1.23]
# ])
# x1 = run(A, b, b_2, 2)
# print("===================")
# b = np.array([[1.2], [2.2], [4.0], [0.0], [-1.2]])
...
# A = np.array([
#     [1.43, 0.21, -0.03, 0.12, -0.13],
#     [-0.03, -1.24, -0.09, 0.17, 0.12],
#     [0.12, -0.03, -1.23, 0.11, -0.03],
#     [0.17, 0.13, -0.03, -1.23, 0.11],
#     [0.11, 0.66, 0.12, -0.03, -1.23]
# ])
# x2 = run(A, b, b_2, 2)
